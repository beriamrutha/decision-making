...
suitable_labs = [lab for lab, capacity in lab_capacities.items() if capacity >= n]
if suitable_labs:
    max_utilization_lab = min(suitable_labs, key=lambda lab: lab_capacities[lab] - n + 1)
    print(max_utilization_lab)
else:
